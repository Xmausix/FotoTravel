...
import React from "react"; // Import React jest opcjonalny w Server Components w Next.js 13+ jeśli nie używasz hooków
  ...
  return (
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow">
          {/* Hero Section */}
          <section
              className="relative h-[calc(100vh-4rem)] flex items-center justify-center text-center text-background shadow-lg">
            <Image
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto"> {/* Dodano mx-auto */}
          ...
          <section className="py-20 bg-primary text-primary-foreground">
            <div className="container mx-auto text-center"> {/* Dodano mx-auto; text-center centruje tekst i elementy inline */}
              <h2 className="text-4xl font-bold mb-6">
                Zainspiruj się podróżą!
              </h2>
              <p className="text-lg mb-8 max-w-2xl mx-auto"> {/* max-w-2xl mx-auto dodatkowo centruje ten paragraf wewnątrz kontenera */}
                Dive into a world of exploration. Find your next destination, plan your trip, and create unforgettable
                memories.
              </p>
        ...
        <footer id="contact" className="py-9  bg-foreground text-background">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8"> {/* Dodano mx-auto */}
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/privacy-policy" className="text-sm hover:text-primary transition-colors">Privacy
                  Policy</Link></li>
              </ul>
              <div className="flex space-x-4 mt-6">
                <Link href="#" aria-label="Facebook"
                      className="text-muted-foreground hover:text-primary transition-colors"><Facebook
                    size={20}/></Link>
                <Link href="#" aria-label="Instagram"
                      className="text-muted-foreground hover:text-primary transition-colors"><Instagram
                    size={20}/></Link>
                <Link href="#" aria-label="Twitter"
                      className="text-muted-foreground hover:text-primary transition-colors"><Twitter size={20}/></Link>
              </div>
            </div>
            <div>
          ...
          <div className="container mx-auto text-center mt-8 pt-8 border-t border-border"> {/* Dodano mx-auto */}
            <p className="text-sm text-muted-foreground">
